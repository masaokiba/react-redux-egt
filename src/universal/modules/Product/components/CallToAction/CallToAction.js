...
import productImg from 'universal/images/4wfs.png';
...
export default class CallToAction extends Component {
  ...
  render() {
    ...
    let dollarsOff = originalPrice - salePrice;
    ...
    return (
      <section style={styles.section}>
        <Grid>
          <Row>
            <Col xs={12}>
              <img style={styles.img} src={productImg} alt="Jump Product Image"/>
                ...
                {discount ?
                  <div style={styles.ctaContainer}>
                    ...
                    <h2 style={styles.price}>
                      Today Just <span style={styles.span}>&#36;{salePrice}</span>
                    </h2>
                  ...
                  <div style={styles.ctaContainerFullPrice}>
                    <h2 style={styles.todaysprice}>
                      Today's Price <span style={styles.span}>&#36;{originalPrice}</span>
                    </h2>
                    <AddToCartButton
                      productId={productId}
                      abandonListId={abandonListId}
