...
import img from './images/Screen-4.png';
              ...
              <Grid fluid>
                <Row>
                  <Col sm={7}>
                    ...
                    <h1 style={styles.h1}>Explosiveness Off The Catch</h1>
                    <p style={styles.p}>An advanced single-leg drill for becoming a deadly slasher on the perimeter (and, against the second line of defense)</p>
                  </Col>
                  <Col sm={5}>
