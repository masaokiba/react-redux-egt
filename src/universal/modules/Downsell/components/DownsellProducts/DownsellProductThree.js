...
import img from './images/Screen-3.png';
              ...
              <Grid fluid>
                <Row>
                  ...
                  <Col sm={7}>
                    ...
                    <h1 style={styles.h1}>Quickness Off The Dribble</h1>
                    <p style={styles.p}>Alan&#8217;s most effective drill for exploding out of a split-leg stance &#8212; the same stance you&#8217;ll take every time you drive to the hoop.</p>
                  </Col>
                </Row>
              </Grid>
